package com.example.myapplication_menu.ui.Datos;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void insertSucursal(String name, String location, byte[] image){
    ...
    public void updateServicioById(String table,String id,String campo1, String campo2, String campo3, byte[] image){
